    ...
    >
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mb-10 text-center">
          <p className="text-base font-medium text-[#3474F4] sm:text-lg">Get Started</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid gap-6 sm:grid-cols-2">
              <div className="space-y-2">
                <label htmlFor="fullName" className="block text-sm font-semibold text-[#333333]">
                  Full Name
                </label>
                <input
                  id="fullName"
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              <div className="space-y-2">
                <label htmlFor="phone" className="block text-sm font-semibold text-[#333333]">
                  Phone
                </label>
                <input
                  id="phone"
              ...
              <div className="space-y-2">
                <label htmlFor="freightType" className="block text-sm font-semibold text-[#333333]">
                  Freight Type
                </label>
                <select
                  id="freightType"
                  name="freightType"
                  className="w-full rounded-lg border border-[#DDDDDD] px-4 py-3 text-[#1A1A1A] focus:border-[#3474F4] focus:outline-none focus:ring-2 focus:ring-[#3474F4]/20 [&>option]:text-[#1A1A1A] [&>option[value='']]:text-[#AAAAAA]"
                >
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              <div className="space-y-2">
                <label htmlFor="origin" className="block text-sm font-semibold text-[#333333]">
                  Origin
                </label>
                <input
                  id="origin"
              ...
              <div className="space-y-2">
                <label htmlFor="destination" className="block text-sm font-semibold text-[#333333]">
                  Destination
                </label>
                <input
                  id="destination"
            ...
            <div className="space-y-2">
              <label htmlFor="details" className="block text-sm font-semibold text-[#333333]">
                Additional Details
              </label>
              <textarea
                id="details"
